...
#ifdef STM32F4
// Analog inputs
#define STEERING_VALUE_PORT GPIOC
#define STEERING_VALUE_PIN GPIOC_OTG_FS_POWER_ON // ADC123_IN10
...
#define IMD_FAULT_INDICATOR_PIN GPIOA_VBUS_FS

#define AMS_FAULT_INDICATOR_PORT GPIOA
#define AMS_FAULT_INDICATOR_PIN GPIOA_PIN8

#define BSPD_FAULT_INDICATOR_PORT GPIOA
#define BSPD_FAULT_INDICATOR_PIN GPIOA_OTG_FS_ID
